...
export default function PatientApp() {
  ...
  const [viewMode, setViewMode] = useState<'dashboard' | 'split' | 'map' | 'list' | 'doctors' | 'admin' | 'doctorDashboard' | 'patientDashboard' | '404'>(window.location.pathname === '/' ? 'dashboard' : '404');
